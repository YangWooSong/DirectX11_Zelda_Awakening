...
CBoxOpenUI::CBoxOpenUI(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    :CUIObject(pDevice, pContext)
{
}

CBoxOpenUI::CBoxOpenUI(const CBoxOpenUI& Prototype)
    :CUIObject(Prototype)
{
}

HRESULT CBoxOpenUI::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CBoxOpenUI::Initialize(void* pArg)
{
...
void CBoxOpenUI::Priority_Update(_float fTimeDelta)
{

}

void CBoxOpenUI::Update(_float fTimeDelta)
{
...
void CBoxOpenUI::Late_Update(_float fTimeDelta)
{
...
HRESULT CBoxOpenUI::Ready_Components()
{
    /* FOR.Com_Shader */
...
CBoxOpenUI* CBoxOpenUI::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CBoxOpenUI* pInstance = new CBoxOpenUI(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX(TEXT("Failed to Created : CBoxOpenUI"));
...
CGameObject* CBoxOpenUI::Clone(void* pArg)
{
    CBoxOpenUI* pInstance = new CBoxOpenUI(*this);

    if (FAILED(pInstance->Initialize(pArg)))
    {
        MSG_BOX(TEXT("Failed to Cloned : CBoxOpenUI"));
        Safe_Release(pInstance);
    }
