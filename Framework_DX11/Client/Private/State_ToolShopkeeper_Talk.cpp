...
CState_ToolShopkeeper_Talk::CState_ToolShopkeeper_Talk(CFsm* pFsm, CNPC* pOwner)
	:CState{ pFsm }
	, m_pOwner{ pOwner }
{
}

HRESULT CState_ToolShopkeeper_Talk::Initialize(_uint iStateNum)
{
...
HRESULT CState_ToolShopkeeper_Talk::Start_State()
{
...
void CState_ToolShopkeeper_Talk::End_State()
{
...
void CState_ToolShopkeeper_Talk::Set_SelectedChoiceBtn()
{
...
void CState_ToolShopkeeper_Talk::Buy_Item()
{
...
CState_ToolShopkeeper_Talk* CState_ToolShopkeeper_Talk::Create(CFsm* pFsm, CNPC* pOwner, _uint iStateNum)
{
	CState_ToolShopkeeper_Talk* pInstance = new CState_ToolShopkeeper_Talk(pFsm, pOwner);

	if (FAILED(pInstance->Initialize(iStateNum)))
	{
		MSG_BOX(TEXT("Failed to Created : CState_ToolShopkeeper_Talk"));
		Safe_Release(pInstance);
	}

	return pInstance;
}
void CState_ToolShopkeeper_Talk::Free()
{
	__super::Free();
}