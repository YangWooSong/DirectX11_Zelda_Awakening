...
void CState_Link_Slash_Hold::Update(_float fTimeDelta)
{
	...
	{
		m_bChargeEnd = true;
		m_pPlayer->Get_EffectSound()->Play_Sound(TEXT("1_Link_ChargeEnd.wav"), 1.f);
	}
	...
	{
		m_iButttonAwayCount++;
		m_pPlayer->Get_PlayerSound()->Play_Sound(TEXT("1_Link_Sword_Charge_Slash.wav"), 1.f);
		m_pPlayer->Get_EffectSound()->Play_Sound(TEXT("1_Sword_AttackCharging.wav"), 1.f);
