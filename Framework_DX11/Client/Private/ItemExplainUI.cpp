...
HRESULT CItemExplainUI::Render()
{
    if (m_isActive)
    {
        ...
        {
            m_pGameInstance->Render_Center(TEXT("Mallang18_Bold"), TEXT("체력을 늘려주는 하트"), XMVectorSet(g_iWinSizeX * 0.52f, g_iWinSizeY * 0.25f, 0.f, 1.f), XMVectorSet(1.f, 1.f, 1.f, m_fAlpha), 0.f, XMVectorSet(0.f, 0.f, 0.f, 1.f), 1.f, true);
            m_pGameInstance->Render_Text(TEXT("Number18_Bold"), TEXT("10    "), XMVectorSet(g_iWinSizeX * 0.48f, g_iWinSizeY * 0.27f, 0.f, 1.f), XMVectorSet(1.f, 0.5f, 0.5f, m_fAlpha), 0.f, XMVectorSet(0.f, 0.f, 0.f, 1.f), 1.f, true);
            m_pGameInstance->Render_Text(TEXT("Mallang18_Bold"), TEXT("     루피"), XMVectorSet(g_iWinSizeX * 0.48f, g_iWinSizeY * 0.27f, 0.f, 1.f), XMVectorSet(1.f, 0.5f, 0.5f, m_fAlpha), 0.f, XMVectorSet(0.f, 0.f, 0.f, 1.f), 1.f, true);
        }
