...
{
public:
	enum PARTICLE_TYPE { CROSS_MINI, BOMB_SMOKE, PLAYER_ITEM_GET, GLOW, SHUTTER_DUST, KEY_DROP, BOX_APPEAR,BOMB, LOCK_BLOCK, HORN, JUMP_DUST, ROLLING_DUST = 12, DEGU_APPEAR, TYPE_END };
