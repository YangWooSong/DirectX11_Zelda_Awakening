...
namespace Client
{
	...
	enum EFFECT_TYPE { MONSTER_DIED_EFFECT, BOMB_FUSE_EFFECT, BOMB_EXPLOSION_EFFECT, PLAYER_ITEM_GET_EFFECT, MONSTER_HIT_EFFECT, PLAYER_CHARGE_SLASH_EFFECT, TAIL_DUNGEON_OPEN, BOX_APPEAR, SPARK_EFFECT, PAWN_HIT_EFFECT,TYPE_END };
