...
{
public:
	enum OWNER_TYPE {TOOTOOLSHOPKEEPER, DEGUTAIL, LINK, STATUE, MARIN, TYPE_END};
	enum LINK_LINE{SWORD, CAMPUS, SMALL_KEY, MAP, LUPEE, STONEBEAK, BOSS_KEY, FEATHER, HORN,LINK_LINE_END};
