...
HRESULT CVIBuffer_Point_Instance::Initialize_Prototype(void* pArg)
{
...
void CVIBuffer_Point_Instance::Stay(_float fTimeDelta)
{
	D3D11_MAPPED_SUBRESOURCE	SubResource{};
...
void CVIBuffer_Point_Instance::Stop_MoveUp(_float fTimeDelta, _float fStopTime)
{
	m_fTimer += fTimeDelta;

	if(m_fTimer > fStopTime)
	{
		D3D11_MAPPED_SUBRESOURCE	SubResource{};
...
CVIBuffer_Point_Instance* CVIBuffer_Point_Instance::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, void* pArg)
{
